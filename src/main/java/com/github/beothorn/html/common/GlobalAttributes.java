...
public class GlobalAttributes {
	...
	/***
	 * The <strong>contenteditable</strong> <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes">global attribute</a> 
	 ...
	 * <p>For the CSS pseudo-class <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/:lang">:lang</a>, 
	 *
	 ...
	 *  <li>0 means that the element should be focusable and reachable via sequential keyboard navigation, but its relative order is defined by the platform convention;</li>
	 ...
	 * </ul>
	 * <p>An element with a 0 value, an invalid value, or no <strong>tabindex</strong> value should be placed after elements with a positive <strong>tabindex</strong> in the sequential keyboard navigation order.</p>
	 *
	 * <br>
